...
router.post('/addMoney', function(req, res, next) {
  ...
  const mockData = Mock.mock({
    "array|100": [
      {
        "value|1-100": 100,
        "userId": "5c6a453ed7bd5147f833fc06",
        "type|0-1": 1,
        "categoryId|1": ["5c6a453ed7bd5147f833fc22", "5c6a453ed7bd5147f833fc21", "5c6a453ed7bd5147f833fc20", "5c6a453ed7bd5147f833fc1f", "5c6a453ed7bd5147f833fc1e"],
        "accountId|1": ["5c6a453ed7bd5147f833fc29", "5c6a453ed7bd5147f833fc28", "5c6a453ed7bd5147f833fc27"],
...
router.post('/searchMoneyList', function(req, res, next) {
  ...
  Money.find(query)
    ...
    .exec(function(err, docs) {
      ...
      res.send(response('查询账单成功', null, { list: docs }))
    })
})
